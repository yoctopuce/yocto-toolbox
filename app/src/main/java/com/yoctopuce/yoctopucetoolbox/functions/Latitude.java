/*********************************************************************
 *
 * $Id: Latitude.java 46698 2021-10-01 06:31:31Z web $
 *
 * Implements Latitude wrapper for Android toolbox
 *
 * - - - - - - - - - License information: - - - - - - - - -
 *
...
import com.yoctopuce.YoctoAPI.YLatitude;
...
public class Latitude extends Sensor
{
// valueCallbackLatitude
// timedReportCallbackLatitude
    protected YLatitude _ylatitude;

    public Latitude(YLatitude yfunc)
    {
       super(yfunc);
       _ylatitude = yfunc;
    }

    public Latitude(String hwid)
    {
       super(hwid);
       _ylatitude = YLatitude.FindLatitude(hwid);
    }
