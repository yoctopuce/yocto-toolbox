/*********************************************************************
 *
 * $Id: Pressure.java 46698 2021-10-01 06:31:31Z web $
 *
...
{
// valueCallbackPressure
// timedReportCallbackPressure
    protected YPressure _ypressure;

    public Pressure(YPressure yfunc)
    {
       super(yfunc);
       _ypressure = yfunc;
    }

    public Pressure(String hwid)
    {
       super(hwid);
       _ypressure = YPressure.FindPressure(hwid);
    }
